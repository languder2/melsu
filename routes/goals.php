...
Route::prefix('cabinet/goals/{entity}/{entity_id}/')->middleware(AuthCabinet::class)->group(function () {
    Route::get('/',                         [GoalsController::class, 'list'])->name('goals.cabinet.list');
    Route::get('on-approval',               [GoalsController::class, 'list'])->name('goals.cabinet.on-approval')->defaults('onApproval', true);
    Route::get('form/{goal?}',              [GoalsController::class, 'form'])->name('goals.cabinet.form');

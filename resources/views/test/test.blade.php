...
<section class="container custom bg-[100%] bg-cover" style="background-image: url(https://melsu.ru/img/bg-section-6.jpg)">
...
<section class="struct-rumz-section min-h-[auto] lg:min-h-[370px] bg-[100%]"
         style="background-image: url(https://melsu.ru/img/bg-section-7.jpg)">
...
<div class="box-heading container custom">
    <h2 class="font-bold text-2xl my-6 lg:mt-[7%] lg:mb-[3.5%] lg:text-end">Поддержка студентов</h2>
</div>
<section class="struct-university-section">
    <div class="container custom">
        <div class="sub-box-menu text-sm sm:text-lg  grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr] lg:p-0 w-[100%]">
            ...
            <div>
                <img src="https://melsu.ru/img/ph-7.jpg" alt="" class="w-[100%] min-h-[100%]">
            </div>
        </div>
    </div>
</section>
...
<section class="struct-rumz-section min-h-[auto] lg:min-h-[370px] bg-[100%]"
         style="background-image: url(https://melsu.ru/img/bg-section-8.jpg)">
    <div class="container custom relative min-h-[auto] lg:min-h-[370px]">
        <div
            class="sub-box-menu grid grid-cols-1 lg:grid-cols-[1fr_1fr] bg-[var(--primary-color)] text-white text-sm sm:text-lg  p-6 w-[100%] lg:w-[70%] lg:absolute lg:bottom-[10px] lg:right-0 mx-auto lg:mx-none">
            <div>

...
@if($category)
    ...
    <div class="flex flex-col gap-4 documents-category-wrapper group">
        <input
        ...
        <div class="text-white flex gap-px">
            ...
            <div
                class="
                        ...
                        {{ $category->publicDocuments()->count() < 1000 ? 'hidden' : 'flex items-center'  }}
                        search-btn
                        group
                    "
            >
            ...
            <div class="flex flex-col gap-3">
                ...
                @foreach($category->publicDocuments() as $document)
                    <div class="flex flex-col gap-2 document">
                        ...
                        @if($document->getOption('link'))
                            <x-common.link :document="$document" />
                        @else

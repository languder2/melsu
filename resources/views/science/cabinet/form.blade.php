...
@section('content')
    <form action="{{ $science->cabinet_save }}" method="POST" class="flex flex-col gap-3" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="flex flex-col gap-3">
            <div class="bg-white p-3 shadow flex gap-3 flex-wrap">
                ...
                <x-form.checkbox.block
                    ...
                    :value="1"
                    label="Опубликовать"
                    :checked=" old('is_show', $science->exists ? $science->is_show : true)"
                    block="pe-2"
                />
                ...
                @if(auth()->user()->isEditor())
                    ...
                    <x-form.checkbox.block
                        ...
                        :value="1"
                        label="Утвердить"
                        :checked=" old('is_approved', $science->exists ? $science->is_approved : true)"
                        block="pe-2"
                    />
                @else
            ...
            <x-editorjs.editor
                ...
                name="content"
                :initialContent=" $science->content "
            />
        </div>
    </form>

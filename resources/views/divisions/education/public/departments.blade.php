...
@php
    $descendants = $division->publicDescendantsByType();

    $faculties      = $descendants->get('faculty') ?: collect();
    $departments    = $descendants->get('department') ?: collect();
    $labs           = $descendants->get('lab') ?: collect();
    $eLabs          = $descendants->get('education-lab') ?: collect();
@endphp

        ...
        <div class="container flex-col flex lg:flex-row justify-between lg:items-end relative z-5 pb-5 py-25 lg:py-10 px-2.5 2xl:px-0">
            <div class="flex flex-col gap-4">
                ...
                <div class="flex gap-2 items-center">
                    <a href="/" class="text-white hover:opacity-80 transition duration-300 ease-linear">Главная</a>
                    <span>
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <a href="mailto:rektorat@mgu-mlt.ru" class="flex items-center gap-2 text-white text-sm">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="font-bold text-white">Расположение:</span>
                <span class="flex items-center gap-2 text-white text-sm">
                    Кабинет:
                    <span class="underline">15.302</span>
                </span>
            </div>
        </div>
</section>

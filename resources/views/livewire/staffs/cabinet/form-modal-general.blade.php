...
<div>
    <label class="block text-xs font-semibold text-gray-700 mb-1">Ссылка на сайт / Профиль</label>
    <input type="text" wire:model="link" class="w-full rounded border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 outline-none" placeholder="https://...">
    @error('link') <span class="text-xs text-red-500 mt-1 block">{{ $message }}</span> @enderror
</div>

<div>
    <label class="block text-xs font-semibold text-gray-700 mb-1">Путь к фото / Имя файла</label>
    <input type="text" wire:model="photo" class="w-full rounded border border-gray-300 px-3 py-1.5 text-sm focus:border-blue-500 outline-none">

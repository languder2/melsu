<section>
    <div class="grid grid-cols-4 min-h-[720px] mb-22">
        <div class="relative top-[20px]">
            <img class="h-full w-full object-cover" src="{{asset('img/univer-subbot/subbot-1.jpg')}}" alt="">
        </div>
        <div>
            <img class="h-full w-full object-cover object-[48%] xl:object-[42%]" src="{{asset('img/univer-subbot/subbot-2.jpg')}}" alt="">
        </div>
        <div class="relative top-[40px]">
            <div class="absolute top-0 bg-[rgba(130,0,0,0.6)] w-full h-[35%] z-10">
            </div>

            <div class="absolute top-[35%] left-0 h-[1px] w-full bg-white"></div>

            <div class="absolute top-[35%] left-0 h-[38%] w-[1px] bg-white"></div>

            <img class="h-full w-full object-cover object-[15%]" src="{{asset('img/univer-subbot/subbot-3.jpg')}}" alt="">

            <div class="absolute top-[35%] right-0 h-[38%] w-[1px] bg-white"></div>

            <div class="absolute bottom-[27%] left-0 h-[1px] w-full bg-white"></div>

            <div class="absolute bottom-0 bg-[rgba(130,0,0,0.6)] w-full h-[27%] z-10">
            </div>
        </div>
        <div class="relative top-[20px]">
            <img class="h-full w-full object-cover object-[45%] xl:object-[18%]" src="{{asset('img/univer-subbot/subbot-4.jpg')}}" alt="">
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-20">
            ...
            <div class='accordion-group grid grid-cols-1 gap-1' data-accordion="default-accordion">
                <div class='accordion-box accordion accord-custm' style="height: 98px;">
                    <button
                        ...
                        <div class="flex gap-5">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="ico-svg">
                                <path d="M16.25 27.4383C15.8389 27.4791 15.4219 27.5 15 27.5C8.09644 27.5 2.5 21.9036 2.5 15C2.5 8.09644 8.09644 2.5 15 2.5C21.9036 2.5 27.5 8.09644 27.5 15C27.5 15.4219 27.4791 15.8389 27.4383 16.25" class="stroke-current" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M9.375 21.25C11.1281 19.4139 13.7765 18.6301 16.25 18.9926M18.1189 11.875C18.1189 13.6009 16.7178 15 14.9894 15C13.2611 15 11.86 13.6009 11.86 11.875C11.86 10.1491 13.2611 8.75 14.9894 8.75C16.7178 8.75 18.1189 10.1491 18.1189 11.875Z" class="stroke-current" stroke-width="1.5" stroke-linecap="round"/>
                                <circle cx="23.125" cy="23.125" r="4.375" class="stroke-current" stroke-width="1.5"/>
                            </svg>
                            <h4 class="font-[600] text-lg">Уважаемые школьники и родители</h4>
                        </div>
                        <svg
                ...
                <div class='accordion-box accordion' style="height: 73px;">
                    <button
                        ...
                        <div class="flex gap-5">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="ico-svg">
                                <path d="M3.125 15C3.125 9.40207 3.125 6.60311 4.86405 4.86405C6.60311 3.125 9.40207 3.125 15 3.125C20.5979 3.125 23.3969 3.125 25.1359 4.86405C26.875 6.60311 26.875 9.40207 26.875 15C26.875 20.5979 26.875 23.3969 25.1359 25.1359C23.3969 26.875 20.5979 26.875 15 26.875C9.40207 26.875 6.60311 26.875 4.86405 25.1359C3.125 23.3969 3.125 20.5979 3.125 15Z" class="stroke-current" stroke-width="1.5"/>
                                <path d="M12.5 11.25C12.5 9.86929 13.6193 8.75 15 8.75C16.3807 8.75 17.5 9.86929 17.5 11.25C17.5 11.7477 17.3546 12.2114 17.1039 12.601C16.3568 13.7621 15 14.8693 15 16.25V16.875" class="stroke-current" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M14.99 21.25H15.0012" class="stroke-current" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>

                            <h4 class="font-[600] text-lg">Основная информация</h4>
                        </div>
                        <svg
                            class='transition duration-300 group-hover:text-white'
                            width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div class='accordion-box accordion' style="height: 73px;">
                    <button
                        ...
                        <div class="flex gap-5">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="ico-svg">
                                <path d="M13.75 7.5L26.25 7.5" class="stroke-current" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M13.75 15L26.25 15" class="stroke-current" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M13.75 22.5L26.25 22.5" class="stroke-current" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M3.75 9.24107C3.75 9.24107 5 10.0558 5.625 11.25C5.625 11.25 7.5 6.5625 10 5" class="stroke-current" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M3.75 22.9911C3.75 22.9911 5 23.8058 5.625 25C5.625 25 7.5 20.3125 10 18.75" class="stroke-current" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>

                            <h4 class="font-[600] text-lg">Вас ждут:</h4>
                        </div>
                        <svg
                            class='transition duration-300 group-hover:text-white'
                            width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
                ...
                <div class='accordion-box accordion' style="height: 73px;">
                    <button
                        ...
                        <div class="flex gap-5">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" class="ico-svg">
                                <path d="M15 27.5C8.09639 27.5 2.5 21.9036 2.5 15C2.5 8.09644 8.09644 2.5 15 2.5C20.5971 2.5 25.2821 6.17862 26.875 11.25H23.75" class="stroke-current" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M15 10V15L17.5 17.5" class="stroke-current" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M27.4438 16.25C27.481 15.8386 27.5 15.4216 27.5 15M18.75 27.5C19.177 27.3595 19.5941 27.1955 20 27.0097M25.9883 21.25C26.2293 20.7855 26.4443 20.3041 26.6313 19.8078M22.7406 25.2865C23.1712 24.9302 23.5789 24.5448 23.961 24.1331" class="stroke-current" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <h4 class="font-[600] text-lg">Когда?</h4>
                        </div>
                        <svg
                            class='transition duration-300 group-hover:text-white'
                            width='22' height='22' viewBox='0 0 22 22' fill='none' xmlns='http://www.w3.org/2000/svg'>
        ...
        <div class="max-h-[600px] relative">
            <div class="absolute top-0 right-0 bg-[rgba(130,0,0,0.6)] w-[80%] h-[13%] z-10">
            </div>
            <div class="absolute top-0 bg-[rgba(130,0,0,0.6)] w-[20%] h-full z-10">
            </div>

            <div class="absolute top-[13%] right-0 h-[1px] w-[80%] bg-white"></div>
            <div class="absolute top-[13%] bottom-[25%] left-[20%] h-[62%] w-[1px] bg-white"></div>

            <img class="h-full w-full object-cover" src="{{asset('img/univer-subbot/subbot-5.jpg')}}" alt="">


            <div class="absolute bottom-[25%] right-0 h-[1px] w-[80%] bg-white"></div>
            <div class="absolute bottom-0 right-0 bg-[rgba(130,0,0,0.6)] w-[80%] h-[25%] z-10">
            </div>
        </div>
    </div>
    <div class="flex flex-col gap-4">
        <button popovertarget="my-popover-1" class="grid grid-cols-1 lg:grid-cols-[minmax(0,_240px)_1fr] gap-4 py-4 px-7 cursor-pointer bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white">
                <h2 class="text-2xl font-semibold">Кафедра гостинничной и ресторанной деятельности</h2>
        ...
        <button popovertarget="my-popover-2" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,_240px)] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white order-2 lg:order-1">
                <h2 class="text-2xl font-semibold">Кафедра менеджмент</h2>
                <p>
        ...
        <button popovertarget="my-popover-3" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[minmax(0,_240px)_1fr] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white">
                <h2 class="text-2xl font-semibold">Кафедра географического образования и лесного дела</h2>
                <p>
        ...
        <button popovertarget="my-popover-4" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,_240px)] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white order-2 lg:order-1">
                <h2 class="text-2xl font-semibold">Кафедра государственно-правовых дисциплин</h2>
                <p>
                    21.12.24 на юридическом факультете Мелитопольского государственного университета кафедрой государственно-правовых дисциплин (Тирон В.О., Кулида О.А.) при участии кафедры гражданско-правовых дисциплин (Минкова О.Г., Гапон С.Н.) в рамках «Университетских суббот» проведён День открытых дверей.
                </p>
                <span class="w-fit border-b border-black group-hover:border-white group-hover:text-white transition duration-300 ease-linear">Подробнее</span>
            </div>
        </button>
        <button popovertarget="my-popover-5" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[minmax(0,_240px)_1fr] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white">
                <h2 class="text-2xl font-semibold">Кафедра биология</h2>
                <p>
        ...
        <button popovertarget="my-popover-6" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,_240px)] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white order-2 lg:order-1">
                <h2 class="text-2xl font-semibold">Кафедра высшей математики и физики</h2>
                <p>
        ...
        <button popovertarget="my-popover-8" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,_240px)] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white order-2 lg:order-1">
                <h2 class="text-2xl font-semibold">Кафедра Специальное (дефектологическое) образование</h2>
                <p>
                    Отчёт 26.10.2024 Университетская суббота. <br><br>
        ...
        <button popovertarget="my-popover-9" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[minmax(0,_240px)_1fr] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white">
                <h2 class="text-2xl font-semibold">Кафедра физической культуры</h2>
                <p>
                    ...
                    <br><br>
                    Преподаватели кафедры рассказали о возможностях обучения, актуальности профессии. <br><br>
        ...
        <button popovertarget="my-popover-10" class="cursor-pointer grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,_240px)] gap-4 py-4 px-7 bg-white group transition duration-300 ease-linear hover:bg-[#C10F1A]">
            ...
            <div class="flex flex-col justify-center gap-6 transition duration-300 ease-linear group-hover:text-white order-2 lg:order-1">
                <h2 class="text-2xl font-semibold">Юридический факультет</h2>
                <p>
...
<style>
    ...
    .accordion-box:hover .accordion-toggle{
        background-color: #C10F1A !important;
    }
    .accordion-toggle h4{
    ...
    .accordion-box:hover h4, .accordion-box:hover .ico-svg{
        color: white !important;
    }
</style>

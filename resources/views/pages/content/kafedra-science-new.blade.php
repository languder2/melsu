            ...
            <div class="order-2 lg:order-1 flex flex-col gap-7">
                <div class="flex flex-col gap-7">
                    ...
                    <div class="grid xl:grid-cols-2 gap-5">
                        <div class="flex flex-col gap-7">
                            <div>
                                <h3 class="font-bold text-xl md:text-3xl">Научная деятельность</h3>
                            </div>
                            <div class="flex flex-col gap-5">
                                <div>
                                    <p>
                                ...
                                <h4 class="font-bold">Направления научных исследований:</h4>
                                <div>
                                    <ul class="list-inside list-disc flex flex-col gap-3 marker:text-[#C10F1A]">
                                        <li>
                        ...
                        <div class="flex flex-col gap-7">
                            <div>
                                <h3 class="font-bold text-xl md:text-3xl">Научные публикации</h3>
                            </div>
                            <div class="flex flex-col gap-5">
                                <a href="#" class="flex gap-5 group">
                                    <div class="flex flex-col gap-2.5">
                                        <span class="font-semibold text-[#C10F1A] text-xl">2025</span>
                                        <span>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1.33301 1.33398H14.6663M14.6663 1.33398V14.6673M14.6663 1.33398L1.33301 14.6673" stroke="#CCCCCC" class="group-hover:stroke-[#C10F1A] transition duration-300 ease-linear" stroke-width="2"/>
                                            </svg>
                                        </span>
                                    </div>
                                    <div>
                    ...
                    <h2 class="font-bold text-xl md:text-3xl">Научные подразделения</h2>
                    <div class="flex flex-col gap-5">
                        <div>
                            <p>В состав факультета входит ряд научных и конструкторских подразделений, в том числе:</p>
                        </div>
                        <div class="grid xl:grid-cols-2 gap-5">
                            <div class="flex flex-col">
                                <div class="flex gap-3">
                                    <div class="relative">
                                        <span class="bg-red-700 absolute text-white text-xs rounded-full h-2.5 w-2.5 flex items-center justify-center animate-ping top-1"></span>
                                    <span class="bg-red-700 relative text-white text-xs rounded-full h-2.5 w-2.5 flex items-center justify-center top-1"></span>
                                    </div>
                                    <p>
                                        It is a long established fact
                                    </p>

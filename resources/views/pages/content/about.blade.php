<section class="container custom lg:p-2.5 mb-3">
    <div class="custom-select-nav center">
        <select name="sources" id="sources" class="custom-select sources" placeholder="Навигация">
            <option value="#melsu-today"><a href="#melsu-today">МелГУ сегодня - это</a></option>
            <option value="#history-melsu"><a href="#history-melsu">История МелГУ</a></option>
            <option value="#cooperation-melsu"><a href="#cooperation-melsu">Международное сотрудничество</a></option>
            <option value="#education-melsu"><a href="#education-melsu">Образование</a></option>
            <option value="#science-melsu"><a href="#science-melsu">Университетская наука</a></option>
            <option value="#schoolchildren-melsu"><a href="#schoolchildren-melsu">МелГУ для школьников</a></option>
            <option value="#library-melsu"><a href="#library-melsu">Научная библиотека МелГУ</a></option>
        </select>
    </div>
</section>
        ...
        <div>
            <div class="bg-[var(--primary-color)] xl:mt-[170px] p-6 text-white">
                ...
                <div class="border-b-[1px] border-white py-3">
                    <h3 class="text-5xl font-[700] mb-3">7</h3>
                    <span>Факультетов</span>
                </div>
                <div class="border-white py-3">
                    <h3 class="text-5xl font-[700] mb-3">15.500</h3>
                    <span>Студентов</span>
                </div>
            </div>
        </div>
...
<section id="history-melsu" class="timeline-carousel">
    <div class="container custom">
        <h2 class="font-bold text-2xl mt-5 lg:mt-12 lg:mb-6 px-2.5">История МелГУ</h2>
    </div>
        ...
        <section class="cd-horizontal-timeline">
            <div class="timeline">
                <div class="events-wrapper">
                    <div class="events">
                        <ol class="timelinePoints">
                            <li><a href="#0" data-date="01/01/1915" class="selected">1874</a></li>
                            <li><a href="#0" data-date="01/09/1922">1922</a></li>
                            <li><a href="#0" data-date="01/12/1933">1933</a></li>
                            <li><a href="#0" data-date="01/12/1937">1937</a></li>
                            <li><a href="#0" data-date="01/12/1939">1939</a></li>
                            <li><a href="#0" data-date="01/12/1943">1943</a></li>
                        </ol>
                ...
                <ul class="cd-timeline-navigation">
                    <li><a href="#0" class="prev inactive"><i class="bi bi-chevron-left"></i></a></li>
...
<section id="education-melsu" class="container custom lg:p-2.5">
    ...
    <div class="grid lg:grid-cols-[29%,69%] xl:grid-cols-[35.5%,60%] lg:gap-x-6 xl:gap-x-[60px]">
        <div>
            <div class="bg-[var(--primary-color)] xl:mt-[170px] p-6 text-white">
                <div class="border-b-[1px] border-white pb-3">
                    <h3 class="text-5xl font-[700] mb-3">48</h3>
                    <span>Направлений подготовки бакалавров</span>
                </div>
                <div class="border-b-[1px] border-white py-3">
                    <h3 class="text-5xl font-[700] mb-3">4</h3>
                    <span>направления подготовки специалистов </span>
                </div>
                <div class="border-white py-3">
                    <h3 class="text-5xl font-[700] mb-3">43</h3>
                    <span>направления подготовки магистров </span>
                </div>
            </div>
        </div>
        <div class="bg-white p-6 border-[1px]">
    ...
    <div class="grid lg:grid-cols-[29%,69%] xl:grid-cols-[35.5%,60%] lg:gap-x-6 xl:gap-x-[60px]">
        <div>
            <div class="bg-[var(--primary-color)] xl:mt-[170px] p-6 text-white">
                ...
                <div class="border-white py-3">
                    <h3 class="text-5xl font-[700] mb-3">3</h3>
                    <span>Научно-образовательных центров</span>
                </div>
            </div>
        </div>
        <div class="bg-white p-6 border-[1px]">

                    ...
                    <div class="flex flex-col xl:flex-row gap-5">
                        <div class="flex flex-col sm:max-w-[240px]">
                            <div class="bg-[#CCCCCC] h-full">
                                <img class="object-cover w-full h-full" src="{{asset('img/clusters/photo.jpg')}}" alt="">
                            </div>
                            <div class="bg-[#252525] p-5 flex flex-col gap-4">
                                <h3 class="font-bold text-xl text-white">Короткая Ирина Александровна</h3>
                                <span class="text-white">Декан факультета</span>
                            </div>
                        </div>
                        <div class="bg-white p-5 flex flex-col gap-7">
                            <div class="flex flex-col gap-5">
                                ...
                                <div class="flex flex-col gap-4">
                                    <a href="tel:+7(990) 106-70-70" class="flex items-center gap-3">
                                        <span>
                                    ...
                                    <a href="mail:f.agrotech@melsu.ru" class="flex items-center gap-3">
                                        <span>
                            ...
                            <div class="flex flex-col gap-5">
                                <h3 class="font-bold text-xl">Расположение деканата очной формы обучения</h3>
                                <div class="flex flex-col gap-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span>
                                            272312, Запорожская область, г. Мелитополь, проспект Б. Хмельницкого, 18, 9 корпус, 1 этаж, каб. 9.105-106
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col gap-5">
                                <h3 class="font-bold text-xl">Расположение деканата заочной формы обучения</h3>
                                <div class="flex flex-col gap-4">
                                    <div class="flex items-center gap-3">
                                        <span>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span>
                                            272312, Запорожская область, г. Мелитополь, проспект Б. Хмельницкого, 18, 9 корпус, 2 этаж, каб. 9.214
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="grid md:grid-cols-[1fr_2fr] gap-5">
                        ...
                        <div>
                            <form
                                ...
                                class="grid grid-cols-1 gap-[12px] lg:gap-3"
                            >
                                <div class="box-btns-card hidden md:grid grid-cols-1 h-fit pb-5 border-b border-[#CCCCCC]">
                                    <label class="btn-filter-card flex justify-start py-3 px-5 h-fit">
                                        <input
                                            type="radio"
                                            name="level"
                                            value=""
                                ...
                                <div class="select-wrapper relative max-h-[50px] block md:hidden">
                                    <input
                                        type="text"
                                        name="level_dropdown"
                                        value=""
                                    ...
                                    >
                                    <ul
                                        class="value-list transition duration-300 ease-in-out absolute top-0 left-0 w-full max-h-0 cursor-pointer list-none mt-[48px] shadow-[2px_24px_17px_-13px_rgba(66,68,90,1)] overflow-hidden z-30"
                                    >
                                        <li data-value="" data-id="" class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out hover:bg-[#820000] hover:text-white">
                                            Все
                                        </li>
                                        <li data-value="bachelor" data-id="bachelor" class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out hover:bg-[#820000] hover:text-white">
                                            Бакалавриат
                                        </li>
                                        <li data-value="specialist" data-id="specialist" class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out hover:bg-[#820000] hover:text-white">
                                            Специалитет
                                        </li>
                                        <li data-value="master" data-id="master" class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out hover:bg-[#820000] hover:text-white">
                                            Магистратура
                                        </li>
                                        <li data-value="colleges" data-id="colleges" class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out hover:bg-[#820000] hover:text-white">
                                            Колледжи
                                        </li>
                                        <li data-value="postgraduate" data-id="postgraduate" class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out hover:bg-[#820000] hover:text-white">
                                            Аспирантура
                                        </li>
                                    </ul>
                                </div>
                                <div class="filters-select-box flex flex-col xl:grid xl:grid-cols-2 gap-[12px] lg:gap-3 ">
                                    <div class="select-wrapper relative max-h-[50px] z-10">
                                        ...
                                        <input class="chosen-value relative top-0 left-0 w-full min-h-[50px] max-h-[50px] text-lg py-3 px-[18px] bg-white transition duration-300 ease-in-out placeholder:text-[black] focus:border-b-[2px] outline-0 z-20"
                                            type="text" value="Очная" data-placeholder="Форма обучения" placeholder="Форма обучения">
                                        <ul
                                            class="value-list transition duration-300 ease-in-out absolute top-0 left-0 w-full max-h-0 cursor-pointer list-none mt-[48px] shadow-[2px_24px_17px_-13px_rgba(66,68,90,1)] overflow-hidden z-20 peer-focus:max-h-80 peer-focus:overflow-y-auto"
                                        >
                                            <li
                                                data-id="full-time"
                                                class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out max-h-0 hover:bg-[#820000] hover:text-white [&.closed]:max-h-0 [&.closed]:overflow-hidden [&.closed]:p-0 [&.closed]:opacity-0 [&.closed]:min-h-[0px]"
                                            >
                                                Очная
                                            </li>
                                            <li
                                    ...
                                    <div class="select-wrapper relative max-h-[50px] z-5">
                                        ...
                                        <input
                                            class="chosen-value relative top-0 left-0 w-full min-h-[50px] max-h-[50px] text-lg py-3 px-[18px] bg-white transition duration-300 ease-in-out placeholder:text-[black] outline-0 z-10 border-b border-white focus:border-gray-200 peer"
                                            type="text"
                                            value="Бюджет"
                                        ...
                                        >
                                        <ul
                                            class="value-list transition duration-300 ease-in-out absolute top-0 left-0 w-full max-h-0 cursor-pointer list-none mt-[50px] shadow-[2px_24px_17px_-13px_rgba(66,68,90,1)] overflow-hidden z-20 peer-focus:max-h-80 peer-focus:overflow-y-auto"
                                        >
                                            <li
                                                data-id="budget"
                                                class="drop-li min-h-[4rem] opacity-100 relative p-[1rem] bg-white text-lg flex items-center cursor-pointer transition duration-300 ease-in-out max-h-0 hover:bg-[#820000] hover:text-white [&.closed]:max-h-0 [&.closed]:overflow-hidden [&.closed]:p-0 [&.closed]:opacity-0 [&.closed]:min-h-[0px]"
                                ...
                                <a href="#" class="p-4">
                                    <div>
                                        <input
                                            ...
                                            value="01.03.02 Прикладная математика и информатика (Математическое моделирование)"
                                            checked
                                        >
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-3 group-hover:text-white">
                                        <div class="flex flex-col">
                                            <span class="font-[400]">180</span>
                                            <span class="font-[400] text-sm text-neutral-700 group-hover:text-white">Проходной балл</span>
                                        </div>
                                        <div class="flex flex-col">
                                            <span class="font-[400] text-sm">25</span>
                                            <span class="font-[400] text-sm text-neutral-700 group-hover:text-white">Бюджетных мест</span>
                                        </div>
                                        <div class="flex flex-col">
                                            <span class="font-[400] text-sm">4 года</span>

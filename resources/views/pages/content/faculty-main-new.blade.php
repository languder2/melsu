...
<section class="container">
    <div class="grid grid-cols-1 2xl:grid-cols-[1fr_2fr_2fr] py-7 px-2.5 2xl:px-0 gap-5">
...
<section class="overflow-hidden">
    <div class="container">
        <div class="grid lg:grid-cols-[2fr_1fr] gap-5 px-2.5 2xl:px-0">
            <div class="order-2 lg:order-1 flex flex-col gap-7">
                ...
                <div class="flex flex-col gap-7">
                    ...
                    <div class="grid 2xl:grid-cols-[51%_auto] gap-5">
                        <div class="flex flex-col gap-7 order-2 2xl:order-1">
                            <div class="flex">
                            ...
                            <div id="box-about-faculty">
                                <p>
                                    Главной целью факультета является качественная подготовка квалифицированных и конкурентоспособных специалистов, умеющих принимать решения в соответствии с запросами социально-экономического развития.
                                </p>
                            </div>
                        </div>
                        <div class="order-1 2xl:order-2">
                            <p>
                                Агротехнологический факультет готовит специалистов в области агрономии, технологий производства продуктов питания растительного и животного происхождения, оборудования и технологий переработки сельскохозяйственной продукции, а также специалистов в сфере сельскохозяйственной техники и гидромелиорации.
                            </p>
                        </div>
                    </div>

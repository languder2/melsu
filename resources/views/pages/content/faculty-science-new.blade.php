<section class="px-2.5 h-[500px] lg:p-0 relative bg-no-repeat bg-center bg-cover flex"
style="background-image: url({{asset('img/faculty/faculty-4.png')}})">
                    ...
                    <div>
                        ...
                        <div class="p-5 bg-[#C10F1A] mb-5" style="background: linear-gradient(330deg,rgba(193, 15, 26, 1) 0%, rgba(193, 15, 26, 0.77) 53%, rgba(217, 91, 99, 1) 100%);">
                            <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-5 text-white text-sm">
                                <div>
                                    + Повышение эффективности производства зерновой продукции путем внедрения современных методов переработки в условиях научно-производственного центра продовольственной безопасности МелГУ (руководитель – к.т.н. Клевцова Т.А.)
                                </div>
                                <div>
                                    + Разработка адаптационных технологий выращивания сельскохозяйственных культур в условиях изменения климата (руководитель – д.с.-х.н., профессор Еременко О.А.)
                                </div>
                                <div>
                                    + Разработка алгоритмов для средств автоматизации систем полива плодовых косточковых культур по физиологическим параметрам деревьев (руководитель – д.т.н., старший научный сотрудник Караев А.И.)
                                </div>
                                <div>
                                    + Также на факультете функционирует научная молодежная лаборатория «Рациональное использование природных ресурсов и повышение устойчивости агроценозов» (руководитель – к.т.н., доцент Колодий А.С.). 
                                </div>
                                <div>
                                    + В рамках выполнения государственных заданий на факультете проводятся научно-практические семинары для освещения и обсуждения результатов научных исследований.
                                </div>
                            </div>
                        </div>
                        <div class="p-5 border border-[#CCCCCC] mb-5">
                            <p class="text-sm">
                                В 2024 году на факультете было проведено 2 Международные научно-практические конференции: «Роль аграрной науки в обеспечении продовольственной безопасности» и ІІІ Международная научно-практическая конференция «Технико-технологическое обеспечение инноваций в агропромышленном комплексе». По результатам работы конференций сформированы Программы конференции и опубликованы Сборники Материалов конференции с размещением в базе данных РИНЦ. 
                            </p>
                        </div>
                        <div class="flex justify-end bg-size-[100%] bg-[0%_61%] mb-5"
                        style="background-image: url({{asset('img/faculty/faculty-5.png')}})">
                            <div class="card-black-glass p-5 sm:w-2/4">
                                <p class="text-white">
                                    Научно-исследовательская работа студентов на кафедрах проводится по различным направлениям в студенческих научных кружках под руководством научных руководителей. На факультете функционирует 18 научных кружков. По результатам работы научных кружков студенты принимают участие в научных конференциях и семинарах, конкурсах разного уровня и занимают призовые места.
                                </p>
                            </div>
                        </div>
                        <div class="p-5 border border-[#CCCCCC] mb-5">
                            <p class="text-sm">
                                В 2024 году на конкурс «Студенческий стартап» в рамках федерального проекта «Платформа университетского технологического предпринимательства» был подан проект старшего преподавателя кафедры «Технология и оборудование пищевых производств» Сергеевой Л.В. на тему: «Разработка профилактически-оздоровительных продуктов питания (хлебцев) на основе проросших зерен», который успешно прошел все этапы и получил финансирование в 1 млн. руб.
                            </p>
                        </div>
                        <div class="flex justify-start bg-size-[100%] bg-[0%_48%]"
                        style="background-image: url({{asset('img/faculty/faculty-6.png')}})">
                            <div class="card-black-glass p-5 sm:w-2/4 xl:w-1/3">
                                <p class="text-white">
                                    Ерещенко Валерий Викторович, студент 3 курса направления подготовки «Продукты питания из растительного сырья» под руководством Сергеевой Л.В. разработал проект «Инновационная технология производства безглютеновых макаронных изделий, обогащенных нутовой мукой».
                                </p>
                            </div>
                        </div>
                    </div>

<section class="incoming-main-box lg:min-h-[990px] lg:max-h-[990px] relative lg:bg-[length:100%_auto] object-contain bg-cover bg-top bg-no-repeat" style="background-image: url({{asset('img/bg-section-9.jpg')}})">
    <div class="overlay-incoming"></div>
    <div class="wrapper-incoming-main-content container custom p-2.5 relative lg:min-h-[990px] lg:max-h-[990px] flex flex-col justify-between">
        <div class="w-60 pt-[100px] mb-[50px] lg:mb-[0px]">
            <h2 class="text-2xl font-[700] text-white mb-4">Лучший выбор профессии будущего</h2>
            <p class="text-lg font-[700] text-white border-b-2 border-white">
                Выбрать образовательную программу
            </p>
        </div>
        <div class="box-incoming-block lg:relative lg:bottom-[-50px] grid grid-cols-1 lg:grid-cols-[1fr,1fr] gap-3 lg:gap-5">
            <div class="bg-[#252422] p-6 min-h-[350px] flex flex-col justify-between">
                <div class="flex justify-between flex-col sm:flex-row">
                    <h2 class="text-xl font-[700] text-white mb-4 w-[100%] sm:w-[35%]">
                        Подготовка к вступительным испытаниям для абитуриентов
                    </h2>
                    <div class="box-incoming-number">
                        <span class="left-span text-white">до</span>
                        <div class="flex items-start sm:flex-col">
                            <h2 class="text-[66px] font-[700] text-white">
                                01
                            </h2>
                            <span class="right-span text-white">декабря 2024</span>
                        </div>
                    </div>
                </div>
                <div>
                    <ul class="text-white">
                        <li class="before:content-['—']">
                            Подготовка к внутреннему испытанию
                        </li>
                        <li class="before:content-['—']">
                            начало занятий в декабре.
                        </li>
                    </ul>
                </div>
                <div class="relative text-white flex justify-between items-center">
                    <a href="#" class="text-white border-b-2 border-white pb-2">Подробнее</a>
                    <span class="text-3xl">⟶</span>
                </div>
            </div>
            <div class="bg-[var(--primary-color)] p-6 min-h-[350px] flex flex-col justify-between">
                <div class="flex justify-between flex-col sm:flex-row">
                    <h2 class="text-xl font-[700] text-white mb-4 w-[100%] sm:w-[35%]">
                    ...
                    <div class="box-incoming-number">
                        <div class="flex items-start sm:flex-col">
                            ...
                            <span class="right-span text-white">ноября в 14:00</span>
                        </div>
                    </div>
                </div>
                <div>
                    <ul class="text-white">
                        <li class="before:content-['—']">
                            Место проведения: МелГУ
                        </li>
                    </ul>
                </div>
                <div class="relative text-white flex justify-between items-center">
                    <a href="#" class="text-white border-b-2 border-white pb-2">Зарегистрироваться</a>
                    <span class="text-3xl">⟶</span>
                </div>
            </div>
        </div>
...
<section class="bg-[var(--primary-color)] mt-6 lg:mt-[70px] mb-12">
    <div class="container custom lg:px-[100px] lg:py-[50px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[45%,45%] gap-3 lg:gap-x-[10%] lg:gap-y-12 lg:mx-auto">
            <div class="text-white">
                ...
                <div class="flex flex-col justify-between min-h-[272px]">
                    ...
                    <div class="flex justify-between flex-col xl:flex-row">
                        <a href="#" class="font-[700] text-sm sm:text-lg border-b-4 border-[var(--secondary-color)] uppercase w-fit mb-3 xl:mb-0">Я после колледжа</a>
                        <a href="#" class="font-[700] text-sm sm:text-lg border-b-4 border-[var(--secondary-color)] uppercase w-fit">Проходные баллы</a>
                    </div>
                </div>
            </div>
            <div class="text-white">
                ...
                <div class="flex flex-col justify-between min-h-[272px]">
                    ...
                    <ul class="list-disc list-inside ps-3 mb-3">
                        ...
                        <li>
                            через операторов почтовый связи
                        </li>
                    </ul>
                    <div class="flex justify-between flex-col sm:flex-row">
                        <a href="#" class="font-[700] text-sm sm:text-lg border-b-4 border-[var(--secondary-color)] uppercase w-fit">Сроки подачи документов</a>
                    </div>
                </div>
            </div>
            <div class="text-white">
                ...
                <div class="flex justify-between flex-col sm:flex-row">
                    <a href="#" class="font-[700] text-sm sm:text-lg border-b-4 border-[var(--secondary-color)] uppercase w-fit">Рейтинговые списки</a>
                </div>
            </div>
            <div class="text-white">
                ...
                <ul class="list-disc list-inside ps-3 mb-3">
                    ...
                    <li>
                        Получить студенческий билет, зачётку и кампусную карту.
                    </li>
                    <li>
                        Встать на учет в военно-учетном столе (для студентов мужского пола очной формы).
                    </li>
                    <li>
...
<section class="object-contain bg-cover bg-center bg-no-repeat lg:py-[50px] mb-12"  style="background-image: url({{asset('img/bg-section-10.jpg')}})">
    <div class="container custom p-2.5">
        <div class="grid grid-cols-1 lg:grid-cols-[1fr,1fr] xl:grid-cols-[1fr,1fr,1fr,1fr] gap-3 lg:gap-5">
            ...
            <div class="box-info-link bg-[var(--secondary-color)] p-2.5 text-white">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Даты вступительной кампании 2025</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Подробнее
                                    <i class="bi bi-arrow-right align-text-top"></i>
            ...
            <div class="box-info-link bg-[#252422] p-2.5 text-white">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Наличие общежития</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Подробнее
                                    <i class="bi bi-arrow-right align-text-top"></i>
            ...
            <div class="box-info-link bg-[#252422] p-2.5 text-white">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Правила приема абитуриентов</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Подробнее
                                    <i class="bi bi-arrow-right align-text-top"></i>
            ...
            <div class="box-info-link bg-[var(--primary-color)] p-2.5 text-white">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Образец договора об оказании платный образовательных услуг</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Подробнее
                                    <i class="bi bi-arrow-right align-text-top"></i>
            ...
            <div class="box-info-link bg-[#252422] p-2.5 text-white">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Положение о работе апелляционной комиссии ФГБОУ ВО «МелГУ»</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Подробнее
                                    <i class="bi bi-arrow-right align-text-top"></i>
            ...
            <div class="box-info-link bg-[var(--secondary-color)] p-2.5 text-white">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Приемная комиссия</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Подробнее
                                    <i class="bi bi-arrow-right align-text-top"></i>
...
<section class="card-section container custom p-2.5">
    <div class="grid grid-cols-1 lg:grid-cols-[65%,25%] xl:grid-cols-[45%,20%] gap-[12px] lg:gap-[10%] xl:gap-[35%] mb-3 lg:mb-0">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[1fr,1fr] xl:grid-cols-[1fr,1fr,1fr] gap-3">
        <div class="card-naprav p-2.5 text-white">
            <a href="#">
                <h2 class="text-xl font-[600]">44.03.05 – Педагогическое образование (с двумя профилями подготовки) (География. Физическая культура)</h2>
    ...
    <div class="more-btns">
        <div class="btn-more-box flex items-center active justify-end">
            <a href="#" class="btn-more">Все программы</a>
...
<section>
    <div class="container custom">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1fr,1fr,1fr,1fr]">
            <div class="jst-block bg-[var(--primary-color)] p-6 text-white hover:opacity-[0.9]">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    ...
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Пошаговое руководство по постулению
                                </span>
                    </div>
                </a>
            </div>
            <div class="jst-block bg-[var(--secondary-color)] p-6 text-white hover:opacity-[0.9]">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Иностранным абитуриентам</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Пошаговое руководство по постулению
                                </span>
            ...
            <div class="jst-block bg-[#d7232e] p-6 text-white hover:opacity-[0.9]">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Инвалидам и лицам с ОВЗ Пошаговое руководство</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                    Пошаговое руководство по постулению
                                </span>
            ...
            <div class="jst-block bg-[#E13A45] p-6 text-white hover:opacity-[0.9]">
                <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-between">
                    <h2 class="font-[700] text-lg">Вопрос-ответ</h2>
                    <div class="text-end">
                                <span class="text-xl font-[400]">
                                   Пошаговое руководство по постулению
                                </span>
...
<div class="box-heading container custom pb-6">
    <h2 class="font-bold text-2xl mt-12 mb-6">Учиться близко и удобно</h2>
    <p class="font-[700] lg:w-[40%]">
...
<section class="container custom">
    <div class="grid grid-cols-1 lg:grid-cols-[1fr,1fr,2fr]">
        <div class="jst-block bg-[#F03541] p-6 text-white hover:opacity-[0.9]">
            <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-center">
                <h2 class="font-[700] text-[128px] leading-[0.9em]">17</h2>
                <div class="">
                                <span class="text-xl font-[400]">
                                    Учебных корпусов в Мелитополе
                                </span>
                </div>
            </a>
        </div>
        <div class="jst-block bg-[#DD333D] p-6 text-white hover:opacity-[0.9]">
            <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-center">
                <h2 class="font-[700] text-[128px] leading-[0.8em]">2</h2>
                <div class="">
                                <span class="text-xl font-[400]">
                                    Общежитий в Мелитополе
                                </span>
                </div>
            </a>
        </div>
        <div class="jst-block bg-[var(--secondary-color)] p-6 text-white hover:opacity-[0.9]">
            <a href="#" class="min-h-[160px] lg:min-h-[295px] flex flex-col justify-center">
                <h2 class="font-[700] text-[128px] leading-[0.9em]">5</h2>
                <div class="">
                                <span class="text-xl font-[400]">
                                    Филиалов в 5 городах
                                </span>
                </div>
            </a>
        </div>
...
<section class="news-section only-news">
    <div class="container custom p-2.5 2xl:p-0">
        <div class="box-nav-btns only-news">
            <div class="nav-btns">
                <a class="news-btn active">Новости</a>
            </div>
            <div class="more-btns">
                <div class="btn-more-box flex items-center active">
                    <a href="#" class="btn-more">Все новости</a>
                    <i class="bi bi-arrow-right-circle-fill"></i>
                </div>
            </div>
        </div>
        <div class="wrapper-news only-news">
            <div class="news-block-box active">
                <div class="news-block">
                    <div class="news-box">
                        ...
                        <a href="#">
                            <img src="../assets/img/news-photo1.jpg" alt="">
                        </a>
                    ...
                    <div class="news-box">
                        ...
                        <a href="#">
                            <img src="../assets/img/news-photo2.jpg" alt="">
                        </a>
                        <div class="descrip-meta-wrap">
                            <div class="meta-box">
                                <a href="#">02.12.2024</a>
                    ...
                    <div class="news-box">
                        ...
                        <a href="#">
                            <img src="../assets/img/news-photo3.jpg" alt="">
                        </a>
                        <div class="descrip-meta-wrap">
                            <div class="meta-box">
                                <a href="#">02.12.2024</a>
                    ...
                    <div class="news-box">
                        ...
                        <a href="#">
                            <img src="../assets/img/news-photo4.jpg" alt="">
                        </a>
                        <div class="descrip-meta-wrap">
                            <div class="meta-box">
                                <a href="#">02.12.2024</a>

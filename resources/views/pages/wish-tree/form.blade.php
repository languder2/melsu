            ...
            <div class="order-2 sm:order-1 lg:order-2">
                <div class="wrapp  bg-[url({{asset('images/wish-tree/border.png')}})] bg-no-repeat p-6 sm:relative">
                    <div class="flex justify-center">
                        <h2 class="text-[32px] md:text-[33px] xl:text-[42px] text-[#F95752] font-[700]">ЕЛКА ЖЕЛАНИЙ МЕЛГУ</h2>
                    </div>
                    <form class="" action="{{route('wish-tree:save')}}" method="POST">
                        ...
                        <div class="grd grid grid-cols-[1fr,1fr] gap-6 text-xl">
                            ...
                            <input type="text" class="border-dotted border-b-2 border-[#C4C4C4] placeholder:text-[#E7E7E7] p-1 font-[400] outline-0 w-[100%]" name="speciality" placeholder="Специальность">
                            <input type="text" class="border-dotted border-b-2 border-[#C4C4C4] placeholder:text-[#E7E7E7] p-1 font-[400] outline-0 col-span-2 md:col-span-1 w-[100%]" name="phone" placeholder="Номер телефона">
                            <input type="text" class="border-dotted border-b-2 border-[#C4C4C4] placeholder:text-[#E7E7E7] p-1 font-[400] outline-0 col-span-2 md:col-span-1 w-[100%]" name="tg" placeholder="Телеграм">
                        </div>
                        <div class="textarea-with-lines">
                            <textarea placeholder="Задай вопрос ректору" maxlength="150" spellcheck="false" class="myTextarea placeholder:text-[#E7E7E7] font-[400]" name="question"></textarea>
                            <div class="line-underline line-underline-1"></div>
                            <div class="line-underline line-underline-2"></div>
                            <div class="charCount text-end text-[#E7E7E7] text-[14px]"><span class="remainingChars">150</span></div>
                        </div>
                        <div class="w-[100%] flex justify-end">
                            <div class="text-area-box textarea-with-lines w-[80%]">
                                <textarea placeholder="Поделись своим желанием" maxlength="350" spellcheck="false" class="myTextarea placeholder:text-[#E7E7E7] font-[400]" name="wish"></textarea>
                                <div class="line-underline line-underline-1"></div>
                                <div class="line-underline line-underline-2"></div>
                                <div class="charCount text-end text-[#E7E7E7] text-[14px]"><span class="remainingChars">350</span></div>
                            </div>
                        </div>
                        <div class="block w-full flex justify-center">
                            <button type="submit" class="rounded-[16px] text-lg py-[4px] px-[12px] text-white bg-[#F95752] border-[1px] border-[#F95752] hover:bg-white hover:text-[#F95752] transition-all duration-300 ease-linear">Отправить</button>
                        </div>
                    </form>

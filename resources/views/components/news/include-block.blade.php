    ...
    <div class="flex flex-col gap-7">
        ...
        <div class="grid md:grid-cols-2 gap-5">
            @foreach($news as $item)
                <div class="@if($loop->first) sm:col-span-2 @endif shadow-md  border">
...
<div class="@container">
{{--    <div class="grid @min-3xl:grid-cols-[1fr_minmax(1fr,600px)] gap-5 max-w-base-container mx-auto mb-4">--}}
    <div class="grid grid-cols-[minmax(auto,700px)_auto] gap-5 max-w-base-container mx-auto mb-4">
        <div class="flex flex-col gap-7 @container">
            ...
            <div class="grid grid-cols-1 @min-3xl:grid-cols-2 gap-5">
                @foreach($news as $item)
                    <div class="shadow-md border @if(!$loop->index) @min-3xl:col-span-2 @endif">

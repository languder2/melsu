<h2 class="text-2xl border-b mb-2 pb-2 font-semibold">
    {{$faculty->name}}
</h2>
...
@foreach($faculty->departments as $department)
    ...
    >
        ...
        <div class="grid grid-cols-[1fr_50px] gap-2">
            <div class="p-2">
                Программ подготовки
            </div>
            <div class="p-2 text-lg text-baseRed font-semibold">
                <a
                    href="{{url("faculties/{$department->code}/specialities")}}"
                    class="hover:underline">
                    {{$department->specialities->count()}}
                </a>
            </div>
        </div>
        <hr class="mb-3">
        ...
        <div class="text-right">
            <a
                href="{{url("faculties/{$faculty->code}/{$department->code}")}}"
